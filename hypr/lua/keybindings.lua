...
-- Movement (arrows = media/volume — Gaab; Shift+arrows still move windows)
...
hl.bind(mainMod .. " + up",    hl.dsp.exec_cmd(HOME .. "/.local/bin/smart_volume.sh up"),   { locked = true, repeating = true })
hl.bind(mainMod .. " + down",  hl.dsp.exec_cmd(HOME .. "/.local/bin/smart_volume.sh down"), { locked = true, repeating = true })
